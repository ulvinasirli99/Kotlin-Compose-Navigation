package dev.tool.jetpacknavigationcomponent.screens.navigation.nested
...
import dev.tool.jetpacknavigationcomponent.navigation.Screens
...
fun LoginScreen(navController: NavController, modifier: Modifier = Modifier) {
    Column(
        ...
        Button(onClick = {
            ...
            navController.navigate(Screens.ForgotScreenRoute.route)
        }) {
